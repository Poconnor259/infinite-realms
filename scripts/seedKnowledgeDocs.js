...
// When running from functions directory: node ../scripts/seedKnowledgeDocs.js
...
try {
    ...
    serviceAccount = require(path.join(process.cwd(), 'atlas-cortex-firebase-adminsdk.json'));
}
